...
VALUES
  (1, 1, 'Alpha', 'Engineer', 'WISHLIST', NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (2, 1, 'Beta', 'Designer', 'APPLIED', NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
ALTER TABLE job_application ALTER COLUMN id RESTART WITH 3;
